...
d = direct_rels = {
    ...
    -2: 'abuel@',
    -1: ('padre', 'madre'),
    0: ('él mismo', 'ella misma'),  # this one is very rarely going to come up, but it'll appear as "Bob Pancakes is Bob Pancakes's self"
    1: 'hij@',
    2: 'niet@',
    3: 'bisniet@',
    4: 'tataraniet@',
...
d_great = 'tátara'   # moves one generation away from self, e.g. great-grandson, great(x2)-grandson...
# nb. for direct ancestors, this pattern has to be used as tátara(xn)-tatarabuel@; need extra rule
...
half_rel = '{p(rrs.half)} {rel}'  # p.e. medio hermano

# = siblings of direct rels / direct rels of siblings =
# add numbers as you need them
i1 = indirect_rels_1 = {
    -1: 'tí@',                          # your parent's sibling
    0: 'herman@',                       # your sibling
    1: 'sobrin@',                       # your sibling's child
}
# prefixes used to continue patterns - put the rules for it in comments
i_great = 'great'  # TODO: use word for direct rel on this same level

# = cousins =
cousin_up = 'tí@'           # any cousin relation that is a higher generation than you
cousin = 'prim@'            # any cousin relation that is on the same generation as you
cousin_down = 'sobrin@'     # any cousin relation that is a lower generation than you
